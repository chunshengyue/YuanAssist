...
data class HomeTabActions(
    ...
    val onOpenXiuweiCalculator: () -> Unit,
...
data class DebugTabActions(
    ...
    val onMoveCombatRoi: (Float, Float, Float, Float) -> Unit,
    val onOpenCombatRoiDialog: () -> Unit,
    val onDismissCombatRoiDialog: () -> Unit,
    val onSaveCombatRoi: () -> Unit,
    val onResetCombatRoi: () -> Unit,
    val onRunTest: () -> Unit,
